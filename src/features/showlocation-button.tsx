  ...
  return (
    <div className="plasmo-flex plasmo-flex-col plasmo-items-center plasmo-justify-center">
      <div className="block plasmo-text-center plasmo-mb-8 plasmo-rounded-lg plasmo-w-[400px] plasmo-h-[200px] plasmo-bg-gradient-to-r plasmo-from-blue-400 plasmo-to-orange-500 plasmo-via-purple-500  plasmo-animate-gradient-x">
        <h2 className="plasmo-text-2xl plasmo-text-center plasmo-pt-20 plasmo-mb-2 plasmo-font-bold plasmo-tracking-tight plasmo-text-white">{location}</h2>
      </div>
      {
        isLoading ? <button disabled type="button" className=" plasmo-text-white plasmo-bg-blue-700 plasmo-hover:bg-blue-800 plasmo-focus:ring-4 plasmo-focus:ring-blue-300 plasmo-font-medium plasmo-rounded-lg plasmo-text-sm plasmo-px-5 plasmo-py-2.5 plasmo-text-center  plasmo-dark:bg-blue-600 plasmo-dark:hover:bg-blue-700 plasmo-dark:focus:ring-blue-800 plasmo-block plasmo-m-auto">
          ...
          >
            <span className="plasmo-relative  plasmo-px-5 plasmo-py-2.5 plasmo-transition-all plasmo-ease-in plasmo-duration-75 plasmo-bg-white plasmo-dark:bg-gray-900 plasmo-rounded-md plasmo-group-hover:bg-opacity-0">
              Show my Location
            </span>
          </button>
      }
